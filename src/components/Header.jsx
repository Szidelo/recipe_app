...
const Header = ({ title, image, info, mode }) => {
	...
	return (
		<header className={headClass}>
			...
			<div className={`absolute flex justify-center items-center w-full ${maskClass} top-0 left-0 z-10 bg-gradient-to-r from-50% from-slate-950 to-transparent`}>
				<div className="flex-1">
					<h1 className="text-5xl text-center font-bold text-white">{title}</h1>
					{info ?? <div className="text-sm mt-4 text-center text-green-500 bg-[#00000090] px-6 py-4 rounded-full ">
